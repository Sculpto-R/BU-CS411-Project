...
// https://raw.githubusercontent.com/mixpanel/mixpanel-js/v2.45.0/dist/mixpanel.min.js
;(function () {
  var k = void 0,
    l = !0,
    q = null,
  ...
  ;(function () {
    function Aa() {
      ...
      if (t.addEventListener)
        'complete' === t.readyState
          ? a()
          : t.addEventListener('DOMContentLoaded', a, F)
    ...
    function m(a) {
      ...
      if ('cookie' !== b && 'localStorage' !== b)
        p.F('Unknown persistence type ' + b + '; falling back to cookie'),
          (b = a.persistence = 'cookie')
      this.h =
        'localStorage' === b && c.localStorage.la() ? c.localStorage : c.cookie
      this.load()
      this.Zb(a)
      this.kd(a)
      this.save()
    ...
    function C(a, b) {
      this.G = b.G
      this.W = new H(a, { G: c.bind(this.j, this), h: b.h })
      this.A = b.A
      this.Nc = b.Oc
      this.ea = b.ea
      this.Xc = b.Yc
    ...
    function ga(a) {
      return { log: ha(p.log, a), error: ha(p.error, a), F: ha(p.F, a) }
    }
    function ha(a, b) {
      return function () {
    ...
    function sa(a, b, d) {
      !c.Na(b) || !b.length
        ...
        : ((d = d || {}),
          ...
          d.m && a && d.m(d.ad || '$opt_in', d.bd, { send_immediately: l }))
    }
    function ia(a, b) {
      return function () {
        var d = F
        try {
          ...
          c && (d = ta(c, { sb: f, Db: g, Cb: y, window: h }))
        } catch (e) {
          p.error(
    ...
    c.a = function (a, b, d) {
      if (!(a === q || a === k))
        if (va && a.forEach === va) a.forEach(b, d)
          ...
          for (
            var c = 0, f = a.length;
            c < f && !(c in a && b.call(d, a[c], c, a) === ka);
            c++
          );
        else
          for (c in a) if (Y.call(a, c) && b.call(d, a[c], c, a) === ka) break
    }
    c.extend = function (a) {
            ...
            a: {
              ...
              if ('{' === h) {
                ...
                for (; h; ) {
                  ...
                  b()
                  f(':')
                  Object.hasOwnProperty.call(j, y) &&
                    g('Duplicate key "' + y + '"')
                  j[y] = r()
                  b()
                  if ('}' === h) {
    ...
    c.ld = function (a) {
      ...
      for (g = 0; g < f; g++) {
        ...
        h !== q &&
          (c > d && (b += a.substring(d, c)), (b += h), (d = c = g + 1))
      }
    ...
    var ya =
      'ahrefsbot,baiduspider,bingbot,bingpreview,facebookexternal,petalbot,pinterest,screaming frog,yahoo! slurp,yandexbot,adsbot-google,apis-google,duplexweb-google,feedfetcher-google,google favicon,google web preview,google-read-aloud,googlebot,googleweblight,mediapartners-google,storebot-google'.split(
        ','
      )
    c.wb = function (a) {
      var b,
    ...
    c.cookie = {
      ...
      qd: function (a, b, c, n, f, g, e) {
        ...
        e
          ? (h = '; domain=' + e)
          : n && (h = (h = ra(t.location.hostname)) ? '; domain=.' + h : '')
        c &&
          ((j = new Date()),
          j.setTime(j.getTime() + 1e3 * c),
    ...
    c.localStorage = {
      la: function (a) {
        ;(a = V(q, a)) ||
          p.error('localStorage unsupported; falling back to cookie store')
        return a
      },
      error: function (a) {
          ...
          if (
            ...
            for (j = e = 0; j < v.length; j++) {
              r =
                '*' == d
                  ...
                  : v[j].getElementsByTagName(d)
              for (o = 0; o < r.length; o++) g[e++] = r[o]
            }
            v = []
            for (j = d = 0; j < g.length; j++)
              g[j].className &&
                c.Na(g[j].className) &&
                a(g[j], u) &&
                (v[d++] = g[j])
            ...
            switch (u) {
              ...
              case '$':
                u = function (a) {
                  return (
                    a.getAttribute(i).lastIndexOf(m) ==
                    a.getAttribute(i).length - m.length
                  )
                }
                break
              case '*':
    ...
    c.info = {
      ...
      Gc: function () {
        return c.extend(
          c.pa({ $os: c.info.Qa(), $browser: c.info.T(z, E.vendor, R) }),
          { $browser_version: c.info.Da(z, E.vendor, R) }
        )
      },
      Ec: function (a) {
    ...
    qa.prototype.Wa = function (a, b, c) {
      function n() {
        ...
        try {
          ...
          i.removeItem(t),
            i.getItem(p) === j && i.removeItem(p),
            i.getItem(m) === j && i.removeItem(m)
        }
      }
      function f() {
        i.setItem(m, j)
    ...
    H.prototype.Ha = function (a, b, d) {
      var n = { id: ea(), flushAfter: new Date().getTime() + 2 * b, payload: a }
      this.Oa.Wa(
        c.bind(function () {
          var b
          try {
        ...
        try {
          ...
          if ((b = this.Sa(c)))
            for (var c = this.X(), n = 0; n < c.length; n++) {
              var e = c[n]
              if (e.id && d[e.id])
                return this.j('Item not removed from storage'), F
            }
        } catch (j) {
    ...
    H.prototype.X = function () {
      var a
      try {
        if ((a = this.h.getItem(this.I)))
          (a = aa(a)),
            c.isArray(a) || (this.j('Invalid storage entry:', a), (a = q))
      } catch (b) {
            ...
            var h = c.bind(function (e) {
                ...
                try {
                  ...
                  if (a.Xb) this.W.hd(i)
                    ...
                    this.j('Network timeout; retrying'), this.flush()
                  else if (
                    c.e(e) &&
                    e.L &&
                    (500 <= e.L.status ||
                    ...
                    if (1 < f.length) {
                      ...
                      this.j('Single-event request too large; dropping', f),
                        this.Jb(),
                        (g = l)
                  else g = l
                  g &&
                    this.W.Hc(
                      ...
                      c.bind(function (a) {
                        a
                          ? ((this.Ea = 0), this.flush())
                          : (this.j('Failed to remove items from queue'),
                            5 < ++this.Ea
                              ? (this.j(
    ...
    i.prototype.ob = function () {
      if (this.ya()) return this.k({ $delete: this.d.H() })
      p.error(
    ...
    i.prototype.k = function (a, b) {
      ...
      return !this.ya()
        ? (this.ec(a),
          c.g(b) || (this.v('verbose') ? b({ status: -1, error: q }) : b(-1)),
          c.truncate(d, 255))
        : this.d.Aa(
            {
              type: 'people',
    ...
    i.prototype.P = function (a, b, d, e) {
      ...
      !c.g(g) &&
        c.e(g) &&
        !c.ka(g) &&
        (f.d.persistence.w(a, g),
        e && (i = e(g)),
        b.call(f, i, function (b, e) {
    ...
    m.prototype.kd = function (a) {
      ...
      if (
        !a.cookie_name &&
        'mixpanel' !== a.name &&
        ((d = 'mp_' + a.token + '_' + a.name), (b = this.h.parse(d)))
      )
        this.h.remove(d), this.h.remove(d, l), this.u(b)
      this.h === c.localStorage &&
        ((b = c.cookie.parse(this.name)),
        c.cookie.remove(this.name),
        c.cookie.remove(this.name, l),
        b && this.u(b))
    }
    ...
    m.prototype.u = function (a, b, d) {
      return c.e(a)
        ? ('undefined' === typeof b && (b = 'None'),
          (this.Ja = 'undefined' === typeof d ? this.nb : d),
          c.a(
            a,
            function (a, c) {
    ...
    m.prototype.o = function (a, b) {
      return c.e(a)
        ? ((this.Ja = 'undefined' === typeof b ? this.nb : b),
    ...
    m.prototype.q = function (a, b) {
      ...
      '__mps' === d
        ...
        ? (c.a(e, function (a, b) {
          ...
          this.w('$unset', e))
        : '__mpr' === d
        ? (o.push(e), this.w('$append', e))
        : '__mpap' === d && (m.push(e), this.w('$unset', e))
    ...
    e.prototype.R = function (a, b, d) {
      ...
      this.ta = []
      this.ra = []
      this.O = { disable_all_events: F, identify_called: F }
      this.p = {}
      if ((this.N = this.c('batch_requests')))
        if (!c.localStorage.la(l) || !N)
          (this.N = F),
            p.log(
          ...
          var f = c.bind(function () {
            this.p.ha.oa || this.p.ha.flush({ Xb: l })
          }, this)
      ...
      this.gc()
      a = c.Xa()
      this.H() || this.u({ distinct_id: a, $device_id: a }, '')
    }
    ...
    e.prototype.za = function (a, b) {
      if (this.c('img'))
        return (
          this.l("You can't use DOM tracking functions with img = true."), F
        )
    ...
    e.prototype.k = function (a, b, d, e) {
      ...
      var a = a + ('?' + c.bc(b)),
        o = this
      if ('img' in b)
        (i = t.createElement('img')), (i.src = a), t.body.appendChild(i)
      else if (h) {
        try {
          f = ba(a, i)
        } catch (m) {
            ...
            if (4 === u.readyState)
              if (200 === u.status) {
                ...
                (a =
                  u.timeout &&
                  !u.status &&
                  new Date().getTime() - w >= u.timeout
                    ? 'timeout'
                    : 'Bad HTTP status: ' + u.status + ' ' + u.statusText),
                  o.l(a),
                  e && (j ? e({ status: 0, error: a, L: u }) : e(0))
          }
          u.send(i)
        } catch (x) {
          o.l(x), (f = F)
    ...
    e.prototype.yc = function () {
      ...
      if (!this.fb()) {
        ...
        this.p = {
          ha: b({ type: 'events', C: '/track/', Ra: '_ev' }),
          Fc: b({ type: 'people', C: '/engage/', Ra: '_pp' }),
          wc: b({ type: 'groups', C: '/groups/', Ra: '_gr' }),
        }
      }
        ...
        j = c.bind(function () {
          ...
          return d
            ? (p.log('MIXPANEL REQUEST:'),
              p.log(d),
              this.k(e, this.Za(d), i, this.ab(b, d)))
            : q
        }, this)
      this.N && !g
        ? f.Ha(d, function (a) {
    ...
    e.prototype.uc = function (a, b) {
      var c = this.cc(a, b),
        e = this.Ya[c]
      if (e === k || e.xa !== a || e.wa !== b)
        (e = new s()), e.R(this, a, b), (this.Ya[c] = e)
      return e
    }
    ...
    e.prototype.$c = function (a) {
      c.g(a)
        ...
        : this.$a(a) || this.persistence.Tc(a)
    }
    var Da = { persistent: l }
    ...
    e.prototype.Ka = function (a, b, c, e, f, g, i, h) {
      ...
      this.o({ $user_id: a })
      this.s('$device_id') ||
        this.u({ $had_persisted_distinct_id: l, $device_id: j }, '')
      a !== j &&
        a !== this.s('__alias') &&
        (this.$('__alias'), this.o({ distinct_id: a }))
      this.O.rb = l
      this.people.fc(b, c, e, f, g, i, h)
      a !== j &&
        this.m('$identify', { distinct_id: a, $anon_distinct_id: j }, { Qb: l })
    }
    e.prototype.reset = function () {
      this.persistence.clear()
      this.O.rb = F
      var a = c.Xa()
      this.u({ distinct_id: a, $device_id: a }, '')
    }
    ...
    e.prototype.Nb = function (a) {
      if (c.e(a))
        c.extend(this.config, a),
          ...
          this.persistence && this.persistence.Zb(this.config),
          (J = J || this.c('debug'))
    }
    e.prototype.c = function (a) {
    ...
    e.prototype.cb = function (a) {
      ...
      'undefined' === typeof b &&
        (this.l(a + ' hook did not return a value'), (b = q))
      return b
    }
    ...
    e.prototype.gc = function () {
      'localStorage' === this.c('opt_out_tracking_persistence_type') &&
        c.localStorage.la() &&
        (!this.ja() &&
          this.ja({ persistence_type: 'cookie' }) &&
          this.Ab({ enable_persistence: F }),
        !this.U() &&
          this.U({ persistence_type: 'cookie' }) &&
          this.Pa({ clear_persistence: F }),
        this.ib({ persistence_type: 'cookie', enable_persistence: F }))
      if (this.U()) this.ba({ clear_persistence: l })
      else if (
        !this.ja() &&
    ...
    e.prototype.Ab = function (a) {
      a = c.extend({ enable_persistence: l }, a)
      this.Q(Ha, a)
      this.ba(a)
    }
    e.prototype.Pa = function (a) {
      a = c.extend({ clear_persistence: l, delete_user: l }, a)
      a.delete_user &&
        this.people &&
        this.people.ya() &&
        (this.people.ob(), this.people.hb())
      this.Q(Ia, a)
      this.ba(a)
    }
    ...
    ;(function () {
      ...
      c.g(w)
        ...
        : w.__loaded || (w.config && w.persistence)
        ? p.F(
